...
switch (_className) do
{
	...
	case "I_G_Van_01_transport_F": {300};
	case "C_Van_01_box_F": {350};
	case "C_Boat_Civil_01_F": {85};
	case "C_Boat_Civil_01_police_F": {85};
	case "C_Boat_Civil_01_rescue_F": {85};
	case "B_Truck_01_box_F": {2000};
	...
	case "I_Boat_Armed_01_minigun_F": {500};
	case "B_G_Boat_Transport_01_F": {45};
	case "B_Boat_Transport_01_F": {45};
	case "O_Truck_03_transport_F": {250};
	case "O_Truck_03_covered_F": {300};
	case "O_Truck_03_device_F": {250};
	case "Land_CargoBox_V1_F": {5000};
	case "Box_IND_Grenades_F": {350};
	case "B_supplyCrate_F": {1000};
	case "B_Heli_Transport_03_F": {250};
	case "B_Heli_Transport_03_unarmed_F": {250};
	case "C_Heli_Light_01_civil_F": {250};
	case "O_Heli_Transport_04_F": {250};
	case "O_Heli_Transport_04_ammo_F": {250};
	case "O_Heli_Transport_04_bench_F": {250};
	case "O_Heli_Transport_04_box_F": {250};
	case "O_Heli_Transport_04_fuel_F": {250};
	case "O_Heli_Transport_04_medevac_F": {250};
	case "O_Heli_Transport_04_repair_F": {250};
	case "O_Heli_Transport_04_covered_F": {250};
	case "IG_supplyCrate_F": {350};
	default {-1};
};