...
__CONST__(life_impound_tank,12000);
life_istazed = false;
...
switch (playerSide) do
{
	case west: 
	{
		life_atmcash = 750000; //Starting Bank Money
...
*/
life_vShop_rentalOnly = ["B_MBT_01_TUSK_F", "I_APC_tracked_03_cannon_F", "O_APC_Wheeled_02_rcws_F", "O_APC_Tracked_02_cannon_F", "B_G_Offroad_01_armed_F"];
...
//[shortVar,reward]
life_illegal_items = [["heroinu",1500],["heroinp",2500],["cocaine",1500],["cocainep",3500],["marijuana",2000],["turtle",3000],["blastingcharge",10000],["boltcutter",5000]];
...
[
	...
	["B_SDV_01_F",25000],
	["B_MRAP_01_F",7500],
	["B_MRAP_01_hmg_F",2500],
	["B_G_Offroad_01_armed_F",2500],
	["I_Boat_Armed_01_Minigun_F",8000],
	["O_Heli_Transport_04_F",8000],
	["O_Heli_Transport_04_box_F",8000],
	["O_Heli_Transport_04_medevac_F",8000],
	["C_Heli_Light_01_civil_F",8000],
	["B_Heli_Transport_03_unarmed_F",8000]
];
