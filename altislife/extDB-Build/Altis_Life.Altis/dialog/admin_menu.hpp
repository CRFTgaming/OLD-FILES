	...
	class controls {
		...
		class Repair: Life_RscButtonMenu {
			...
			h = (1 / 25);
                ...
                class VehicleMarkers : Life_RscButtonMenu {
                        idc = 2912;
                        text = "V Markers";
                        onButtonClick = "[] spawn life_fnc_adminVehicleMarkers;";
                        x = -0.06 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
                        y = 0.93;
                        w = (6.25 / 40);
                        h = (1 / 25);
                ...
                class RepairVehicle : Life_RscButtonMenu {
                        idc = 2913;
                        text = "$STR_Admin_RepairVehicle";
                        onButtonClick = "[] spawn life_fnc_adminRepairVehicle;";
                        x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
                        y = 0.93;
                        w = (6.25 / 40);
                        h = (1 / 25);
                ...
                class TeleportToTarget : Life_RscButtonMenu {
                        idc = 2914;
                        text = "$STR_Admin_TeleportToTarget";
                        onButtonClick = "[] spawn life_fnc_adminTpToTarget;";
                        x = 0.26 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
                        y = 0.93;
                        w = (6.25 / 40);
                        h = (1 / 25);
