...
/* ********************************************************************************* */
	...
	_UAL = false;		// Anti Spawn Local Vehicle	    /* true or false */
	// Anti Spawn Local Vehicle:
		_ALV =
		[
			'M240Nest_DZ','Old_bike_TK_CIV_EP1','Old_bike_TK_INS_EP1','MMT_Civ','TT650_Civ',
			'ATV_US_EP1','CSJ_GyroC','ParachuteWest','ParachuteEast','ParachuteG'
		];
...
[
	"","RscMainMenu","RscMoveHigh","#WATCH","#WATCH0","#USER:_keyMenu",
...
[
	...
	"dayz_myCursorTarget","s_player_craftZombieBait","s_player_butcher_human","s_player_makeBomb","s_player_zombieShield","s_player_upgrademoto","s_player_cleanguts",
