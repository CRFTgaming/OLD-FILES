...
[] execVM "scripts\HeliLift\=BTC=_Lift\=BTC=_LiftInit.sqf";
...
BTC_get_liftable_array =
{
	...
	switch (typeOf _chopper) do
	{
		...
		case "CH_47F_EP1_DZ"   : {_array = ["LandVehicle","Car","Truck","Wheeled_APC","Tracked_APC","Air"];};
		case "CH_47F_EP1_DZE"  : {_array = ["LandVehicle","Car","Truck","Wheeled_APC","Tracked_APC","Air"];};
		case "Mi17_Civilian_DZ": {_array = ["LandVehicle"];};
		case "Mi17_DZ"         : {_array = ["LandVehicle"];};
		case "Mi17_DZE"        : {_array = ["LandVehicle"];};
		case "USEC_ch53_E"     : {_array = ["LandVehicle","Car","Truck","Air"];};
		case "CH53_DZE"        : {_array = ["LandVehicle","Car","Truck","Air"];};
	};
	_array
};
