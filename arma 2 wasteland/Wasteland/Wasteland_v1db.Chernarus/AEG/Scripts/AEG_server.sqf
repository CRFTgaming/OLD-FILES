...
{ 
    ...
    [_object, _logic , _name, _supplies] execVM "AEG\Scripts\AEG_monitor.sqf";
 ...
 _nul = execVM "AEG\Functions\AEG_fnc_supply.sqf";
...
if (!isDedicated) then
{
    _nul = [] execVM "AEG\Scripts\AEG_common.sqf"; 
};
...
_nul = execVM "AEG\Scripts\AEG_damage.sqf";
