...
private ["_unit","_target","_pos","_targetPos","_angle","_target_damag","_meh"];
_unit = player;
...
if((player distance (getMarkerPos "gunshop_m")) < 200) exitwith {};
if((player distance (getMarkerPos "gunshop_m_2")) < 200) exitwith {};
if((player distance (getMarkerPos "gunshop_m_3")) < 200) exitwith {};
if((player distance (getMarkerPos "gunshop_m_4")) < 200) exitwith {};
